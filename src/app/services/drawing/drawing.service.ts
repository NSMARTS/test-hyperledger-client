...
export class DrawingService {
   ...
   * Drawing Start
   */
  start(context: CanvasRenderingContext2D, points: number[], tool: { type: any; color: any; width: number; }) {
   ...
   * Drawing Move
   */
  move(context: CanvasRenderingContext2D, points: string | any[], tool: { width: number; color: any; type: any; }, zoomScale: number, sourceCanvas: HTMLCanvasElement) {
  ...
  end(context: CanvasRenderingContext2D, points: string | any[], tool: { width: number; color: any; type: string; }) {
    context.lineCap = "round";
    context.lineJoin = 'round';
    context.lineWidth = tool.width;
    context.strokeStyle = tool.color;
  ...
  /**
       * 지우개 marker 표시
       */
  eraserMarker(ctx: { strokeStyle: string; fillStyle: string; lineWidth: number; beginPath: () => void; arc: (arg0: any, arg1: any, arg2: number, arg3: number, arg4: number, arg5: boolean) => void; stroke: () => void; closePath: () => void; }, point: any[], width: number) {
  ...
  // Thumbnail에 그리기
  drawThumb(data: { points: any; tool: any; }, thumbCanvas: { getContext: (arg0: string) => any; }, thumbScale: any) {
 ...
 */
  ...
  async rxPointer(data: { points: any[]; tool: { type: string; }; }, sourceCanvas: { getContext: (arg0: string) => any; width: number; height: number; }, targetCanvas: any, scale: number, docNum: any, pageNum: any) {
    console.log(data)
   ...
   *
   */
  rxDrawing(data: any, sourceCanvas: any, targetCanvas: any, scale: any, docNum: any, pageNum: any) {
    const tmpData = {
      data,
      sourceCanvas,
      targetCanvas,
   ...
   * @param thumbScale
   */
  rxDrawingThumb(data: { points: any; tool: any; }, thumbCanvas: { getContext: (arg0: string) => any; }, thumbScale: any) {
    const thumbCtx = thumbCanvas.getContext('2d');
    // prepare scale
    thumbCtx.save();
    thumbCtx.scale(thumbScale, thumbScale);
