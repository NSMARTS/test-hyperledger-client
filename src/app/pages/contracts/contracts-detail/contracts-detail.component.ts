...
import {
  EditInfo,
  EditInfoService,
} from './../../../services/edit-info/edit-info.service';
  ...
  setCanvas() {
    ...
    if (this.data?.status === 'pending' && !this.data?.managerMode) {
      ...
      ctx!.fillRect(
        0,
        0,
        this.pdfViewer.nativeElement.width,
        this.pdfViewer.nativeElement.height
      );
      this.canvasService.addEventHandler(
        this.signCover.nativeElement,
        this.pdfViewer.nativeElement,
        currentTool,
        1
      );
    }
